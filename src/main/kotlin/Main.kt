...
var especeFlamkip = EspeceMonstre(4,"Flamkip","Animal",12,8,13,16,7,50,10.0,5.5,9.5,9.5,6.5,22.0,"Petit animal entouré de flammes, déteste le froid","Sa flamme change d'intensité selon son énergie","Impulsif, joueur, loyal")
...
var route1 = Zone(1,"Prairie",1500,mutableListOf(especeSpringleaf,especeAquamy),null, null)
...
var monstre = Partie(1,joueur,route1)
